...
class SuppressionGroupFetch extends BaseCommand {
    async run() {
      await super.run();
...
SuppressionGroupFetch.description = 'Fetch a Suppression Group'
SuppressionGroupFetch.flags = Object.assign(
  { 
...
module.exports = SuppressionGroupFetch;
...
class SsoIntegrationCreate extends BaseCommand {
    async run() {
      await super.run();
      const result = await this.createSsoIntegration()
      this.output(result)
    }

    async createSsoIntegration() {
...
SsoIntegrationCreate.description = 'Create an SSO integration'
SsoIntegrationCreate.flags = Object.assign(
  { 
...
module.exports = SsoIntegrationCreate;
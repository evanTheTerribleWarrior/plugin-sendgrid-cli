...
class MCSegmentsListV1 extends BaseCommand {
    async run() {
      await super.run();
...
MCSegmentsListV1.description = 'Retrieve a list of segments - v1 API'
MCSegmentsListV1.flags = Object.assign(
  { 
...
module.exports = MCSegmentsListV1;